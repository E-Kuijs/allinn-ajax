...
export const defaultContent: AppContent = {
  ...
  termsVersion: 'v1.0.0',
  termsText:
    'Door een account aan te maken ga je akkoord met de gebruiksvoorwaarden van ALL-INN AJAX en ALL-INN MEDIA. Gebruik van de app is op eigen risico; voor directe of indirecte schade wordt geen aansprakelijkheid aanvaard binnen de grenzen van de wet. Alle teksten, logo\'s en content blijven auteursrechtelijk beschermd en mogen niet zonder toestemming worden gekopieerd of verspreid. Betalingen of transacties die via externe apps of wallets worden gedaan zijn volledig de verantwoordelijkheid van de betrokken gebruikers. All-Inn Media is geen partij in deze transacties.',
